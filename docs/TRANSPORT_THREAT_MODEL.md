...
- the seven-tool baseline allowlist, plus only those read-only battery and volume tools whose independent compile/runtime gates are both enabled, as documented in README and the authorization policy;
