...
3. Typed construction tests reject empty, relative, filesystem-root, missing, non-directory, and symlinked roots; invalid listener declarations; unauthenticated policy paired with non-loopback declarations; requested but uncompiled capabilities; and optional-client initialization failure.
