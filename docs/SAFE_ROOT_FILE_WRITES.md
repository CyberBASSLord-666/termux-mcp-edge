...
- default, named full-suite, and raw all-feature Rust suites; fixture parity; validator v11 and device harness v11; all seven governed Android cross-builds and applicable native official-Termux gates; exact-head CI/Security; and direct physical observation when required by release classification.
