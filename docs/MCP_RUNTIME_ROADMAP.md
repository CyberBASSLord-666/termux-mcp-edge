...
- Exact-source command artifact within the seven-artifact matrix, with strict-v2 native ARM64 official-Termux evidence comprising exactly 29 MCP requests plus a separate typed wrong-name construction-failure phase, including executable/cwd pathname replacement, pre-service rejection and redaction evidence, and complete provenance checks.
